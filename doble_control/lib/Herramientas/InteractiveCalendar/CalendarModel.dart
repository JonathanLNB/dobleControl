...
class CalendarEvent extends CalendarBase {
  ...
  factory CalendarEvent.Disable(DateTime date, List<Clase> events) {
    return CalendarEvent(
        date: date, events: events, type: ECalendarCellType.Disable);
  }

  factory CalendarEvent.Enable(DateTime date, List<Clase> events) {
    return CalendarEvent(
        date: date, events: events, type: ECalendarCellType.Enable);
  }

  factory CalendarEvent.Today(DateTime date, List<Clase> events) {
    return CalendarEvent(
        date: date, events: events, type: ECalendarCellType.Today);
  }

  factory CalendarEvent.Selection(DateTime date, List<Clase> events) {
    return CalendarEvent(
        date: date, events: events, type: ECalendarCellType.Selection);
  }

  factory CalendarEvent.SelectedToday(DateTime date, List<Clase> events) {
    return CalendarEvent(
